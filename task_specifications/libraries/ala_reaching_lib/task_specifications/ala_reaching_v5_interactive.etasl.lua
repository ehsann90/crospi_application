...
-- Finish only in automatic mode.
-- auto_active = conditional(w_auto_progress - constant(0.001), constant(1.0), constant(0.0))
-- finish_error = (constant(1.0) - s) + (constant(1.0) - auto_active) * constant(10.0)
